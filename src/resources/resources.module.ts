...
import { ResourceRepository, ResourceBookingRepository } from './repositories';
...
@Module({
  ...
  exports: [ResourceService, ResourceBookingService, ResourceRepository, ResourceBookingRepository],
})
